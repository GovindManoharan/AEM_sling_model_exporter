...
import com.otf.core.utils.ContentFragmentUtils;
...
public class DAMContentFragmentImpl implements DAMContentFragment {
    ...
    private String type;
    private List<DAMContentElement> elements=Collections.emptyList();
    ...
    public List<DAMContentElement> getElements() {
    	List<DAMContentElement> clonedElements = new ArrayList<>();
